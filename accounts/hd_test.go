...
func TestHDPathParsing(t *testing.T) {
	tests := []struct {
		...
		{"m/0x8000002C/0x8000003c/0x80000000/0x80000000/0x80000000/0x80000000", DerivationPath{0x80000000 + 44, 0x80000000 + 60, 0x80000000 + 0, 0x80000000 + 0, 0x80000000 + 0, 0x80000000 + 0}},
