...
func (b *BackendTest) SetupIndependentStorageConnection(hostEnodeURL string) (*storage.Session, error) {
	return &storage.Session{}, nil
}

func (b *BackendTest) StorageSessionNegotiateDone(session *storage.Session) error {
	return nil
}
