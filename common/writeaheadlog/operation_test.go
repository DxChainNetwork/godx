...
func TestOperation_verify(t *testing.T) {
	tests := []struct {
		...
		{
			op: Operation{
				Name: "This name is long, long enough that I can ever believe. Someone writing this name must be a genius, who is talented, diligent, and handsome. I know that you cannot argue with that. Neither do I. This is the truth over the universe, born with the intellect of human beings. It is the truth that shine and provide like the sun",
				Data: []byte{1,1,1,1,1},
			},
