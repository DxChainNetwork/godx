...
func TestBlockSubscription(t *testing.T) {
	...
	var (
		...
		genesis     = core.DefaultGenesisBlock().MustCommit(db)
		chain, _    = core.GenerateChain(params.TestChainConfig, genesis, ethash.NewFaker(), db, 10, func(i int, gen *core.BlockGen) {}, nil)
